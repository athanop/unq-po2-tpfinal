...
class UsuarioTest {
	 ...
	 * Calificacion.CHINCHE_FOLIADA, ubicacion1, usuarioBasico1); }
	 * 
	 * @Test void testConstructorUsuario() {
	 * assertEquals(usuarioBasico1.getAplicacion(), app); }
	 * 
	 * @Test void testUsuarioBasicoSubeUnaMuestraALaApp() { muestra2 = new
	 * Muestra(imagen1, Calificacion.GUASAYANA, ubicacion1, usuarioBasico1);
	 * usuarioBasico1.enviarMuestra(muestra2);
	 * 
	 * assertTrue(usuarioBasico1.subioMuestraAlSistema(muestra2)); }
	 * 
	 * @Test void testUsuarioBasicoOpinaUnaFotoDeUnaMuestraYaSubidaEnLaApp() {
